<div>
    <div class="d-flex">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Kuesioner /</span> Lihat Jawaban
        </h4>
    </div>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Kuesioner</th>
                        <th>Deskripsi</th>
                        <th style="width: 1px;">Responden</th>
                    </tr>
                </thead>
                <tbody class="table-border-bottom-0">
                    ...
                    @forelse ($rows as $row)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('admin.lihat-jawaban.detail', $row->id) }}" class="btn btn-sm btn-dark d-flex align-items-center">

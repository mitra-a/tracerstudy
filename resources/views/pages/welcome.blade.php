                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-6 text-start">
                                    ...
                                    <p class="fs-4 text-white animated slideInRight d-none d-md-block" style="line-height: 37px; text-align: justify">
                                        Kami menyambut Anda dalam perjalanan yang tak ternilai dalam menggali potensi dan kesuksesan setelah meninggalkan bangku kuliah. <b>Tracer Study FT UNM</b> adalah jendela yang membuka pandangan ke arah masa depan
                                    </p>

                                    <p class="fs-4 text-dark animated slideInRight d-block d-md-none" style="line-height: 37px; text-align: left">
                                        <b>Tracer Study FT UNM</b> adalah jendela yang membuka pandangan ke arah masa depan
                                    </p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative h-100">
                        <div class="service-text rounded p-5">
                            ...
                            <p class="mb-0 text-center mx-auto" style="width: 80%">Akses halaman tracer study FT UNM pada tautan <a href="{{ env('APP_URL') }}">{{ env('APP_URL') }}</a></p>
                        </div>
                    </div>
                </div>

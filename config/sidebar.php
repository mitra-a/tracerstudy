    ...
    [
        ...
        'child' => [
            [
                ...
                'active' => ['admin.mahasiswa.index', 'admin.mahasiswa.create', 'admin.mahasiswa.update'],
            ],
            [
                'title' => 'Validasi Akun',
                'route' => 'admin.mahasiswa.validasi',
                'active' => 'admin.mahasiswa.validasi',
            ],
            [
                'title' => 'Hapus Akun',
                'route' => 'admin.mahasiswa.delete',
                'active' => 'admin.mahasiswa.delete',
            ],
        ],
    ],
    [
